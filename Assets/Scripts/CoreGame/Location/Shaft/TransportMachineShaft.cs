...
public class TransportMachineShaft : MonoBehaviour
{
	...
	public TransportConfig Config => CurrentShaft.Config;  // Lấy config từ Shaft
	public Shaft CurrentShaft;                          // Shaft hiện tại
	#endregion
